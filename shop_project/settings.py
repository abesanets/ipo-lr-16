...
SECRET_KEY = 'django-insecure-!2t&2$yy+$ql)%avv_un5s3m2+wgqe)lx4ep#gzd5^9vjbop_i'
...
# ==================== DRF НАСТРОЙКИ ====================
REST_FRAMEWORK = {
    # Задание 6: только аутентифицированные пользователи
...
EMAIL_HOST_PASSWORD = 'ваш_код'        # ← пароль приложения
